...
<div class="wp-storemapper-wrap wrap">
	...
	<p><?php echo wp_kses_post( __( 'To get your user account ID, <a href="https://www.storemapper.co/users/sign_in" target="_new">log in to your Storemapper account</a> &amp; navigate to your dashboard page. The url in your browser\'s address bar should look something like <code>https://www.storemapper.co/users/{account_id}/stores</code>. Enter the number represented by {account_id}.', 'wp-storemapper' ) ); ?></p>
	...
	<p><?php esc_html_e( "Once your account id is entered above you can utilize one of the following methods to insert your Storemapper widget into your website's content...", 'wp-storemapper' ); ?></p>
